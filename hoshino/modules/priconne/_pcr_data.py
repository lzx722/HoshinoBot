CHARA_NAME = {
    ...
    1701: ['环奈', 'カンナ', '桥本环奈', '毛大力', '妈大力', '罗志祥', '静态美女'],
    ...
    1137: ['アカリ(エンジェル)', '天使阿卡丽', '天使茜里', '茜里(天使)', '天使妹妹法', 'Akari(Angel)', '天使妹法'],
    1138: ['依里(天使)', 'Yori(Angel)', '天使姐法', '天使姐姐法', 'ヨリ(エンジェル)', '天使依里'],
    1139: ['纺希(万圣节)', '🎃🕸️', '万圣裁缝', '万裁', '鬼裁', '万圣蜘蛛侠', '鬼才', '瓜裁', 'ツムギ(ハロウィン)', '🎃🕷️', 'Tsumugi(Halloween)'],
    1140: ['万剑', 'レイ(ハロウィン)', 'Rei(Halloween)', '怜(万圣节)', '瓜剑', '万圣剑圣'],
    1141: ['万圣跳跳虎', '🎃🐅', '万圣老虎', '茉莉(万圣节)', '瓜虎', 'マツリ(ハロウィン)', 'Matsuri(Halloween)'],
    1900: ['フィオ', '爱梅斯', 'アメス', 'Fio', 'Amesu', '菲欧'],
    1907: ['大古', 'Taigo', 'タイゴ', '鬼道大吾', '大吾'],
    1909: ['Nebia', 'ネビア', 'Nevia', '涅比亚'],
    1910: ['真崎', 'Masaki', 'マサキ'],
    1911: ['Mineru', 'ミネルβ', 'ミネル', 'MineruBeta', '米涅尔', '米涅尔β'],
    1914: ['Goushin', 'ゴウシン', '豪绅'],
    1915: ['克里吉塔', 'クレジック', 'Kurejikku'],
    1916: ['基洛', 'キイロ', 'Kiiro'],
    1917: ['Seen', 'ゼーン', '善'],
    1918: ['兰法', 'ランファ', 'Ranfa'],
    1919: ['Anzoorudo', '阿佐尔德', 'アンゾールド'],
    1920: ['ミソラ', '美空', 'Misora'],
    1142: ['モニカ(マジカル)'],
    1143: ['トモ(マジカル)'],
    1144: ['アキノ(クリスマス)'],
    ...
    1155: ['コッコロ(儀装束)'],
    1156: ['ユイ(儀装束)'],
    1064: ['紫布菜', 'Shephy', '雪菲', 'Shefi', 'シェフィ'],
    1157: ['カスミ(サマー)'],
    1158: ['リマ(シンデレラ)'],
    1159: ['マコト(シンデレラ)'],
    1160: ['マホ(シンデレラ)'],
    1806: ['キャル(プリンセス)'],
    1162: ['クロエ(聖学祭)', 'Kuroe(Seigakusai)', '克萝依(圣学祭)'],
    1163: ['琪爱儿(圣学祭)', 'チエル(聖学祭)', 'Chieru(Seigakusai)'],
    1164: ['ユニ(聖学祭)'],
    1165: ['时间旅行龙锤', '穿越梨老八', '祈梨(时间旅行)', 'Inori(TimeTravel)', 'イノリ(タイムトラベル)', '穿越龙锤'],
    1166: ['カヤ(タイムトラベル)'],
    1901: ['菲欧', 'フィオ', 'Fio'],
    1167: ['工菜', 'Aoi(Sagyoufuku)', '韭菜', 'アオイ(作業服)', '碧(工作服)', '碧(作业服)'],
    1168: ['Tamaki(Sagyoufuku)', '珠希(工作服)', '工猫贼', '工猫剑', '珠希(作业服)', '工贼', 'タマキ(作業服)'],
    1169: ['ミフユ(作業服)'],
    1170: ['エリコ(サマー)'],
    1171: ['シズル(サマー)'],
    1803: ['レイ(プリンセス)'],
    1172: ['望(夏日)', '泳装偶像', 'nozomi(summer)', '泳装望', '水望', '夏日望', '水偶像', '夏日偶像', '潒', 'ノゾミ(サマー)'],
    1173: ['水千', '汘', '泳装千歌', 'チカ(サマー)', 'chika(summer)', '千歌(夏日)'],
    1174: ['漨', 'tsumugi(summer)', '纺希(夏日)', '水裁缝', '水彩', 'ツムギ(サマー)', '水纺希', '泳装裁缝', '水裁', '泳装纺希'],
    1175: ['江户深月', 'mitsuki(ooedo)', '大江户深月', '深月(大江户)', '江s', '江月', 'ミツキ(オーエド)'],
    1183: ['星弓星', '初音(初音&刊)', '星刊星', 'hatsune(hatsune&shiori)', 'ハツネ(ハツネ&シオリ)'],
    1184: ['星弓弓', '星弓刊', '星刊刊', 'シオリ(ハツネ&シオリ)', '星刊弓', 'shiori(hatsune&shiori)', '刊(初音&刊)'],
    1807: ['ハツネ&シオリ', '星弓', '食堂泼辣酱', '初音&刊', '姊妹丼', '替身弓', '贴贴弓', '姊妹弓', '姐妹丼', '星刊', '姐妹弓', '白金之星', 'hatsune&shiori', '双子弓'],
    1176: ['大江户雪', '江户雪哥', '江哥', '江户雪', '江雪', '江户小雪', 'yuki(ooedo)', 'ユキ(オーエド)', '雪(大江户)'],
    1177: ['カオリ(ハロウィン)'],
    1178: ['ニノン(ハロウィン)'],
    1179: ['スズナ(ハロウィン)'],
    1180: ['克蕾琪塔', '富婆', 'クレジッタ', 'kurejitta'],
    1185: ['カリン'],
    1190: ['イオ(ノワール)'],
    1191: ['クウカ(ノワール)'],
    1200: ['シズル(ノワール)'],
    ...
    1202: ['クウカ(ノワール)'],
    1203: ['シズル(ノワール)'],
    1192: ['マヒル(クリスマス)', '圣诞奶牛', '蛋牛', '真阳(圣诞节)', 'mahiru(xmas)', '圣牛'],
    1193: ['リノ(クリスマス)'],
    1199: ['但丁', '圣诞布丁', 'miyako(xmas)', '蛋丁', 'ミヤコ(クリスマス)', '圣诞宫子', '宫子(圣诞节)']
}
